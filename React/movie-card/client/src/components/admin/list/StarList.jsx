...
const handleModalSubmit = async () => {
    ...
    const handlePopoverOpen = async (starId) => {
        try {
            ...
            setPopoverContent(
                <div>
                    <img src={`http://localhost:5320/uploads/stars/${star.image}`} alt={star.name} style={{ width: '50px', height: 'auto' }} />
                    <p>Name: {star.name}</p>
...
<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', height: '8vh', width: '100%' }}>
                <h2 style={{ color: 'white', height: '100%' }}>Star List</h2>
  <div style={{ width: '35%', height: '60%', background: 'transparent', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Select style={{ width: '50%', height: '100%', marginRight: '0.5rem' }} placeholder="Select country" onChange={handleCountryChange}>
    ...
    <input type="search"
      ...
      style={{ width: '50%', height: '100%', marginRight: '0.5rem', borderRadius: '5px', border: '1px solid #ccc', padding: '0.5rem' ,marginTop:'0'}}
          />
        </div>
  <button style={{ width: '15%', height: '60%', background: '#fff', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '5px', border: 'none', cursor: 'pointer' ,margin:'0' }}>
          <Link to='/admin/post-star' style={{fontSize:'15px', textDecoration: 'none', color: '#000' }}>post new Star</Link>
                </button>
      </div>
            <div style={{ overflowY: 'auto',    height: '67vh' }}>
